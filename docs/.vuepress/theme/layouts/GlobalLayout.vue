...
<script>
import GlobalLayout from "@app/components/GlobalLayout.vue"; //node_modules/@vuepress/core/lib/client/components/GlobalLayout.vue
...
.content-wrapper {
    ...
    min-height: calc(100vh - 80px - 62px - 160px);
    ...
    @media (max-width: $MQMobile) {
        & {
            ...
            min-height: calc(100vh - 20px - 62px - 100px);
        }
    }
}
</style>
